...
# Add correlation coefficient
p_range <- sp_range + stat_cor(method = "pearson", label.x = 0.3, label.y = 7) + xlim(0, 1)
...
# Add correlation coefficient
p_rscale <- sp_rscale + stat_cor(method = "pearson", label.x = 0.3, label.y = 1) + xlim(0, 1)
...
# Add correlation coefficient
p_log <- sp_log + stat_cor(method = "pearson", label.x = 7, label.y = 16)
p_log
